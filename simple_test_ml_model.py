...
test_cases = [
    {'name': 'Original',       'mp': mp_original, 'mq': mq_original, 'K_I': K_I_original},
    {'name': 'Aggressive mq',  'mp': mp_original, 'mq': 0.01,        'K_I': K_I_original}, # Lower mq = stiffer voltage
    {'name': 'Weak mq',        'mp': mp_original, 'mq': 0.10,        'K_I': K_I_original}, # Higher mq = more voltage sag
]
